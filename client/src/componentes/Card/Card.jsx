...
function Card({ flags, name, continents, id }) { // Define el componente como una funcion
  const { width } = useWindowDimensions();       //Este hook se utiliza para obtener las dimensiones de la ventana del navegador
  const movil = 460;
  if (width > movil) {
    return (
